...
import static io.github.milesreimann.cloudsystem.k8s.mapper.K8sNodeMapper.RESOURCE_CPU;
import static io.github.milesreimann.cloudsystem.k8s.mapper.K8sNodeMapper.RESOURCE_MEMORY;
